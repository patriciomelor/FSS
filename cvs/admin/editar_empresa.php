...
<html>
  <head>
    ...
    <title>Editar Empresa | ICCM</title>
      ...
      <!-- Content Wrapper. Contains page content -->
       <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Editar empresa<br>
            <small>Aqui podras editar la informaci&oacute;n de las empresas</small>
          </h1>
                    ...
                    <tbody>
                     <?php
						...
						while($resultados = $db->fetch_array($consulta)){
							...
							<td>'.$resultados['rut_representante'].'</td>
							<td>'.$resultados['giro'].'</span></td>
							<td>'.$resultados['nombre_tipo_empresa'].'</span></td>		
							<td><span class= "xestado" data-type="select"  data-pk="'.$resultados['id_empresa'].'" >'.$resultados['nombre_estado'].'</span></td>
							</tr>';		
						}
						}
						?>
