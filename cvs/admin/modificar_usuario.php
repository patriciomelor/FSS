...
<html>
  <head>
    ...
    <title>Modificar Usuarios | ICCM</title>
  ...
  <body class="skin-blue">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            ...
            <small>Aqui se modifican los datos de los usuarios<br><br></small>
          </h1>
		  <div class="row">
          <div class="col-md-6 col-xs-12">
		   <div class="box box-success">
                <!-- form start -->
                <form  method="post" action="modificar_registro_persona.php" role="form">
				<div class="box-body">
				  
				<?php 
					$id = $_GET['id'];	
					$db = new MySQL();
					$consulta = $db->consulta("Select * from persona p, comunas c, profesion_oficio po, tipo_persona ti,
					prevision_salud psa, prevision_social pso, estado_civil ec, estado e
					where 
					c.comuna_id = p.id_comuna 
					and po.id_profesion_oficio = p.id_profesion_oficio
					and ti.id_tipo_persona = p.id_tipo_persona
					and psa.id_prevision_salud = p.id_prevision_salud
					and pso.id_prevision_social = p.id_prevision_social
					and ec.id_estado_civil = p.id_estado_civil
					and e.id_estado = p.id_estado 
					and p.id_persona = ".$id."");
					$resultados2 = $db->fetch_array($consulta);
	...
	<div class="form-group">
		...
		<option value="<?php echo $resultados2['id_tipo_persona'] ?>"><?php echo $resultados2['nombre_tipo_persona'] ?> (Dato actual)</option>
	...
	<div class="form-group">
		...
		<input id="nombre_persona" name="nombre_persona"
		value ="<?php echo $resultados2['nombre_persona']?>" type="text" placeholder="" class="form-control input-md" required="">
	</div>

<!-- Text input-->
	<div class="form-group">
		<label for="apellido_paterno_persona">Apellido paterno:</label>  
		<input id="apellido_paterno_persona" name="apellido_paterno_persona"
		value ="<?php echo $resultados2['apellido_paterno_persona']?>" type="text" placeholder="" class="form-control input-md" required="">
	</div>

<!-- Text input-->
	<div class="form-group">
	  <label for="apellido_materno_persona">Apellido materno:</label>  
	  <input id="apellido_materno_persona" name="apellido_materno_persona" type="text"
		value ="<?php echo $resultados2['apellido_materno_persona']?>"placeholder="" class="form-control input-md" required="">
	</div>
...
<!-- Text input-->
	<div class="form-group">
	  ...
	  value ="<?php echo $resultados2['rut_persona']?>">
	</div>
...
<!-- Text input-->
	<div class="form-group">
	  ...
	  value ="<?php echo $resultados2['email_persona']?>">
	</div>
...
<!-- Text input-->
	<div class="form-group">
	  ...
	  <input id="telefono_persona" name="telefono_persona" type="text" placeholder="" class="form-control input-md" required=""
	   ...
	   value ="<?php echo $resultados2['telefono_persona']?>">
	</div>
...
<!-- Password input-->
	<div class="form-group">
		...
		value ="<?php echo $resultados2['clave']?>">
	</div>
...
<!-- Text input-->
	<div class="form-group">
		...
		value ="<?php echo $resultados2['fecha_de_nacimiento']?>">
	</div>
...
<!-- Text input-->
	<div class="form-group">
		...
		value ="<?php echo $resultados2['direccion_persona']?>">
	</div>
...
<!-- Select Basic -->
	<div class="form-group">
		...
		<option value ="<?php echo $resultados2['comuna_id']?>"><?php echo $resultados2['comuna_nombre']?> (Dato Actual)</option>
		<?php
		$db = new MySQL();
	...
	<div class="form-group">
		...
		<option value ="<?php echo $resultados2['id_profesion_oficio']?>"><?php echo $resultados2['nombre_profesion_oficio']?> (Dato Actual)</option>
		<?php
		$db = new MySQL();
...
<div class="form-group">
  <label for="id_prevision_social">Previsi&oacute;n social:</label>
    <select id="id_prevision_social" name="id_prevision_social" class="form-control">
		<option value ="<?php echo $resultados2['id_prevision_social']?>"><?php echo $resultados2['nombre_prevision_social']?> (Dato Actual)</option>
	<?php
	$db = new MySQL();
...
<div class="form-group">
  <label for="id_prevision_salud">Previsi&oacute;n salud:</label>
    <select id="id_prevision_salud" name="id_prevision_salud" class="form-control">
		<option value ="<?php echo $resultados2['id_prevision_salud']?>"><?php echo $resultados2['nombre_prevision_salud']?> (Dato Actual)</option>
	<?php
	$db = new MySQL();
...
<div class="form-group">
  <label for="id_estado_civil">Estado civil:</label>
	...
	<option value ="<?php echo $resultados2['id_estado_civil']?>"><?php echo $resultados2['nombre_estado_civil']?> (Dato Actual)</option>
	<?php
	$db = new MySQL();
...
<div class="form-group">
  ...
  <textarea id="comentarios" name="comentarios" placeholder="" class="form-control input-md"> <?php echo $resultados2['comentarios']?></textarea>
</div>

<div class="form-group">
  <label for="id_estado">Estado:</label>
    <select id="id_estado" name="id_estado" class="form-control">
	<option value ="<?php echo $resultados2['id_estado']?>"><?php echo $resultados2['nombre_estado']?> (Dato Actual)</option>
