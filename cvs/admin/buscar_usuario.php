...
<html>
  <head>
    ...
    <title>Buscar Usuarios | ICCM</title>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                     <?php
						...
						?>
						<tr>
							<td><a href="modificar_usuario.php?id=<?php echo $resultados['id_persona'] ?>"><?php echo $resultados['rut_persona'] ?></a></td>
							<td><?php echo $resultados['nombre_persona'] ?></td>
							<td><?php echo $resultados['apellido_paterno_persona'] ?> <?php echo $resultados['apellido_materno_persona'] ?></td>
							<td><?php echo $resultados['telefono_persona'] ?></td>	
