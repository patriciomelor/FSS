...
<html>
  ...
  <body class="skin-blue">
	...
	<!-- form start -->
	<form  method="post" action="registro_obra_contrato.php" role="form">
	<div class="box-body">
	<div class="form-group">
	<label for="fecha_contrato">Fecha de contrato:</label>  
	<input id="fecha_contrato" name="fecha_contrato" type="text" placeholder="" class="form-control input-md" required="" 
	value="<?php echo  $fecha= date("d/m/Y").""; ?>">
	</div>
	
	<div class="form-group"> <?php $id_obra1 = $_POST['id_obra1'];?>    
	  
		<input type="hidden" name="id_obra1" value="<?php echo $id_obra1?>" >
	</div>
<div class="form-group">
...
<button type="submit" class="btn btn-primary">Enviar</button>
	...
	<script>
	  	...
	  	$(function () 
		{
			...
			$('#fecha_fin_servicios').datepicker();
