...
<html>
  <head>
    ...
    <title>Buscar Contrato | ICCM</title>
      ...
      <!-- Content Wrapper. Contains page content -->
       <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Buscar Contratos<br>
            <small>Aqui podras buscar la informaci&oacute;n de los contratos</small>
          </h1>
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                     <?php
						...
						?>
						<tr>
							<td><?php echo $resultados['id_contrato'] ?></td>	
							<td><?php echo $resultados['fecha_contrato'] ?></td>
							<td><?php echo $resultados['nombre_persona'] ?> <?php echo $resultados['apellido_paterno_persona'] ?> <?php echo $resultados['apellido_materno_persona'] ?></td>
							<td><?php echo $resultados['nombre_trabajo'] ?></td>	
							<td><?php echo $resultados['valor_moneda_trabajo'] ?></td>	
							<td><?php echo $resultados['nombre_tipo_contrato'] ?></td>	
							<td><?php echo $resultados['dia_inicio_servicios'] ?></td>	
