...
mysql_query("insert into persona values (id_persona,'$nombre_persona','$apellido_paterno_persona','$apellido_materno_persona',
'$rut_persona','$email_persona','$telefono_persona','$clave_persona','$fecha_de_nacimiento','$genero_persona','$direccion_persona',
'$id_comuna','$id_profesion_oficio','$id_prevision_social','$id_prevision_salud','$id_estado_civil','$id_tipo_persona','$comentarios','$id_estado')")or die(mysql_error());

print "<script type=\"text/javascript\">"; 
	print "alert('Se agrego el nuevo usuario')";
	print "</script>";  
