...
<html>
  <head>
    ...
    <title>Agregar Contrato de trabajo CPSP | ICCM</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Nuevo contrato de prestaci&oacute;n de servicios profesionales<br>
            <small>Aqui puedes agregar los datos necesarios para el nuevo contrato de prestaci&oacute;n de servicios profesionales<br><br></small>
          </h1>
		  <div class="row">
