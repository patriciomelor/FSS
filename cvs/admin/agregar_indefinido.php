    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Nuevo contrato indefinido<br>
            <small>Aqui puedes agregar los datos necesarios para el nuevo contrato indefinido<br><br></small>
          </h1>
		  <div class="row">
          <div class="col-md-6 col-xs-12">
		   <div class="box box-success">
                <!-- form start -->
		<form  method="post" action="registro_contr_indef.php" role="form">
                  <div class="box-body">
...
<div name="anexos">
		...
		<textarea id="objeto_del_contrato" name="objeto_del_contrato" class="form-control input-md require-if-active" data-require-pair="#anexo1"></textarea>	
		</div>
		<div class="form-group">
		<label for="extension_del_contrato">Extensi&oacute;ndel Contrato:</label>  
		<textarea id="extension_del_contrato" name="extension_del_contrato" class="form-control input-md require-if-active"data-require-pair="#anexo1"></textarea>
		</div>
		</div> 
		</section>
		</div> 
		...
		<input id="precio_de_los_servicios" name="precio_de_los_servicios" type="text"  class="form-control input-md require-if-active" data-require-pair="#anexo2">
		</div> 
		<div class="form-group">
		<label for="forma_de_pago">Forma de pago:</label>  
		<input id="forma_de_pago" name="forma_de_pago" type="text" class="form-control input-md require-if-active" data-require-pair="#anexo2">
		</div> 
		<div class="form-group">
		<label for="impuestos_asociados">Impuetos Asociados:</label>  
		<input id="impuestos_asociados" name="impuestos_asociados" type="text"  class="form-control input-md require-if-active" data-require-pair="#anexo2">
		</div>
		</div>
		</section>
		</div>	
		...
		<input type="checkbox"id="anexo3"> 
		<div class="reveal-if-active">
		<section class="content-header">		
		<div class="row">
		<div class="form-group">
		<label for="han_convenido_en">Han convenido en:</label>  
		<input id="han_convenido_en" name="han_convenido_en" type="text" class="form-control input-md require-if-active" data-require-pair="#anexo3">
		</div>
		<div class="form-group">
		<label for="observacion_y_fundamento">Observaci&oacute;n y Fundamento:</label>  
		<textarea id="observacion_y_fundamento" name="observacion_y_fundamento" class="form-control input-md require-if-active"data-require-pair="#anexo3"></textarea>
		</div>
		</div>
		</section>
		</div>
