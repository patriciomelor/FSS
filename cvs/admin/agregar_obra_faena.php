...
<html>
  <head>
    ...
    <title>Agregar Contrato de trabajo Obra Faena | ICCM</title>
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Nuevo contrato obra - faena<br>
            <small>Aqui puedes agregar los datos necesarios para el nuevo contrato obra - faena<br><br></small>
          </h1>
		  <div class="row">
...
<div class="form-group">
  ...
  <textarea id="faena" name="faena" placeholder="" class="form-control input-md"></textarea>
</div>
